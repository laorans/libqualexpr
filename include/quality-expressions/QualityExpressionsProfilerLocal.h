...
extern "C" {
  ...
  struct profiling_event_t * qualExpr_startEvent(enum qualexpr_event_local_t semantic, long long value);
  void qualExpr_stopEvent(struct profiling_event_t * eventStarted, long long value);
