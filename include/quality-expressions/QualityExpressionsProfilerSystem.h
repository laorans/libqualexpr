...
static type atomic_add(type &var, type value)	{ return __sync_add_and_fetch(&var, value); }
...
{
public:
  /* Constructor */ QualExprSemaphore(void) : m_mutex()	{ initSemaphore(); }
  /* Destructor */ ~QualExprSemaphore(void)			{ closeSemaphore(); }
...
protected:
  void initSemaphore(void)		{ pthread_mutex_init(&m_mutex, NULL); }
  void closeSemaphore(void)		{ pthread_mutex_destroy(&m_mutex); }
