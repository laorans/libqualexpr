...
// #  warning "C++11 mode, using 'unordered_map'"
#  include <unordered_map>
#else
// #  warning "C++98 mode, using 'map'"
...
public:	// Data structure Declarations
  typedef std::unordered_map<std::string, QualityExpressionEntry *>		QualityExpressionSet_T;
...
public:		// Class Definitions
  ...
  void				registerQualityExpression(const QualityExpression &expression, std::vector<QualityExpressionID_T> &p_idList);
...
private:	// Internal functions
  ...
  void				registerQualityExpressionEntry(const QualityExpression &expression, std::vector<QualityExpressionID_T> &p_idList);
