...
namespace quality_expressions_core
{
  ...
  */
  ...
  {
  public:
    /* Constructor */        QualExprAggregatorBandwidthAverage(size_t id) : QualExprAggregatorBandwidth(id) { reset(); }
    /* Constructor */        QualExprAggregatorBandwidthAverage(QualExprAggregatorNamespace &aggregNs) : QualExprAggregatorBandwidth(0)	{ aggregNs.registerNewAggregator('~', this); }
  ...
  public:
    ...
    virtual const char *			name(void) const						{ return "~bw"; }                                       //!< Aggregator fully qualified name.
    virtual const char *			description(void) const						{ return "Average bandwidth"; }                         //!< Aggregator description.
    virtual QualExprAggregator *		build(size_t id) const						{ return new QualExprAggregatorBandwidthAverage(id); }  //!< Auto-constructor.
  };
  ...
  */
  ...
  {
  public:
    /* Constructor */        QualExprAggregatorBandwidthMax(size_t id) : QualExprAggregatorBandwidth(id) { reset(); }
    /* Constructor */        QualExprAggregatorBandwidthMax(QualExprAggregatorNamespace &aggregNs) : QualExprAggregatorBandwidth(0)	{ aggregNs.registerNewAggregator('+', this); }
  ...
  public:
    ...
    virtual const char *			name(void) const						{ return "+bw"; }                                       //!< Aggregator fully qualified name.
    virtual const char *			description(void) const						{ return "Max bandwidth"; }                             //!< Aggregator description.
    virtual QualExprAggregator *		build(size_t id) const						{ return new QualExprAggregatorBandwidthMax(id); }      //!< Auto-constructor.
  };
  ...
  */
  ...
  {
  public:
    /* Constructor */        QualExprAggregatorBandwidthMin(size_t id) : QualExprAggregatorBandwidth(id) { reset(); }
    /* Constructor */        QualExprAggregatorBandwidthMin(QualExprAggregatorNamespace &aggregNs) : QualExprAggregatorBandwidth(0)	{ aggregNs.registerNewAggregator('-', this); }
  ...
  public:
    ...
    virtual long64_t				evaluate(void) const						{ return value(); }					//!< Aggregator evaluation.
    virtual const char *			name(void) const						{ return "-bw"; }                                       //!< Aggregator fully qualified name.
    virtual const char *			description(void) const						{ return "Min bandwidth"; }                             //!< Aggregator description.
    virtual QualExprAggregator *		build(size_t id) const						{ return new QualExprAggregatorBandwidthMin(id); }      //!< Auto-constructor.
