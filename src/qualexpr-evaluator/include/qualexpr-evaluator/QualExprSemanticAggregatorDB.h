...
namespace quality_expressions_core
{
  ...
  */
  ...
  public: // -- Access API
    void   	display(const std::string &indent, std::stringstream &s) const; //!< Display the full namespace description.
  ...
  public: // -- Semantic aggregation API
    ...
    QualExprSemanticAggregator & 	pushAggregator(const std::string &eventName, const std::string aggregName) throw(Exception);	//!< Build a semantic aggregator. @return the aggregator ID.
